...
//    ResourceBundle rb = ResourceBundle.getBundle("lets_get_certified.localisation.Mill", localeCA);
    ResourceBundle rb = ResourceBundle.getBundle("locale/Mill", localeCA);
  ...
  public static void ignoreAmericanBundle() { // finds Mill_en.properties
    ...
    //      - Mill_en.properties
    //      - Mill.properties (default bundle)
    ResourceBundle rb = ResourceBundle.getBundle("locale/Mill", localeUS);
  ...
  public static void usingDefaultLocale() { // finds Mill_en_IE.properties
    ...
    //      - Mill_en.properties
    //      - Mill.properties (default bundle)
    ResourceBundle rb = ResourceBundle.getBundle("locale/Mill", localeFR);
    System.out.println(rb.getString("open"));// is open
