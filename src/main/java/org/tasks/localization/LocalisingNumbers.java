package org.tasks.localization;
...
//        parseCurrencies();
  ...
  public static void formatNumbers() {
    ...
    double n = 77_000.11;
    System.out.println(
        NumberFormat.getInstance().format(n));                   // 77,000.11 (en_IE locale)
  ...
  public static void formatCurrencies() {
    ...
    double n = 23.22;
    System.out.println(
        NumberFormat.getCurrencyInstance().format(n));               // €23.22 (en_IE locale)
  ...
  public static void parseNumbers() {
    ...
    try {
      System.out.println(
          NumberFormat.getNumberInstance(Locale.US).parse(unitedStatesNumber));  // 77000.11
      System.out.println(
          NumberFormat.getNumberInstance(Locale.ITALY).parse(italianNumber));    // 77000.11
      System.out.println(
          NumberFormat.getNumberInstance(Locale.FRANCE).parse(frenchNumber));    // 77000.11
  ...
  public static void parseCurrencies() {
    ...
    try {
      System.out.println(
          NumberFormat.getCurrencyInstance().parse(irishCurrency));                    // 23.22
      System.out.println(
          NumberFormat.getCurrencyInstance(Locale.US).parse(unitedStatesCurrency));    // 23.22
      System.out.println(
          NumberFormat.getCurrencyInstance(Locale.ITALY).parse(italianCurrency));      // 23.22
      System.out.println(
          NumberFormat.getCurrencyInstance(Locale.UK).parse(unitedKingdomCurrency));   // 23.22
    } catch (ParseException ex) {
      ex.printStackTrace();
    }
  }
