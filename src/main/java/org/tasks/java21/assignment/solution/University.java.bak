...
import org.tasks.java21.assignment.solution.AccountingDept;
import org.tasks.java21.assignment.solution.BusinessFaculty;
import org.tasks.java21.assignment.solution.Department;
import org.tasks.java21.assignment.solution.EngineeringFaculty;
import org.tasks.java21.assignment.solution.Faculty;
import org.tasks.java21.assignment.solution.HumanitiesFaculty;
import org.tasks.java21.assignment.solution.LecturerRecord;
import org.tasks.java21.assignment.solution.SocialCareDept;
import org.tasks.java21.assignment.solution.SoftwareEngineeringDept;
...
void main() {
  ...
  LecturerRecord alanAustin = new LecturerRecord("Alan Austin", 64, businessFaculty,
      accountingDept);
  ...
  LecturerRecord lisaBloggs = new LecturerRecord("Lisa Bloggs", 65, humanitiesFaculty,
      socialCareDept);
...
void seqSet() {
  ...
  BusinessFaculty businessFaculty = new BusinessFaculty();
  AccountingDept accountingDept = new AccountingDept();
  LecturerRecord janeAustin = new LecturerRecord("Jane Austin", 24, businessFaculty,
      accountingDept);
  LecturerRecord charlotteBronte = new LecturerRecord("Dr. Charlotte Bronte", 35, businessFaculty,
      accountingDept);
  LecturerRecord anneBronte = new LecturerRecord("Anne Bronte PhD", 54, businessFaculty,
      accountingDept);
...
void seqMap() {
  ...
  humanitiesMap.putLast(kingLear,
      "Father");  // regan=Middle, goneril=Eldest, cordelia=Youngest, kingLear=Father
  System.out.println(
      humanitiesMap);      // {regan=Middle, goneril=Eldest, cordelia=Youngest, kingLear=Father}
  ...
  System.out.println("pollLastEntry() :"
      + humanitiesMap.pollLastEntry());    // kingLear=Father {regan=Middle, goneril=Eldest, cordelia=Youngest}
