...
//    copyBinaryFile(true);
  ...
  public static void copyTextFile(boolean buffering) {
    File src = new File(
        "src/main/resources/nio/source.txt");
    File dest = new File(
        "src/main/resources/nio/target.txt");
  ...
  public static void copyBinaryFile(boolean buffering) {
    ...
    System.out.println("Working Directory = " + System.getProperty(
        "user.dir"));// C:\Users\skennedy\Documents\NetbeansProjects\Udemy
